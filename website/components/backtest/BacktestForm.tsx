  ...
  return (
    <div className="space-y-6">
      ...
      <section className="border border-[#1E293B] bg-[#0F172A] p-5 lg:p-6" aria-label="Experiment evidence">
        {!result && <div className="flex min-h-[260px] flex-col justify-between">
          <div>
            <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-[#00D09C]">Run / Evidence</p>
            <h3 className="mt-2 text-lg font-semibold text-white">Awaiting a submitted experiment</h3>
            <p className="mt-2 max-w-md text-sm leading-6 text-[#94A3B8]">Run the configuration at left to place its measured return, risk summary, and complete trade ledger here.</p>
          </div>
          <p className="border-t border-white/10 pt-4 font-mono text-[10px] uppercase tracking-[0.16em] text-[#64748B]">Evidence belongs to the exact configuration submitted to the backtest service.</p>
        </div>}
      {result && (
        <div className="space-y-4">
