...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050508] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-epsilon-gold/5 rounded-full blur-3xl animate-float" style={{ animationDelay: '-3s' }} />
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-up">
        <div className="text-center mb-8">
          ...
          <p className="text-white/35 text-sm mt-1">Sign in to your trading account</p>
        </div>
