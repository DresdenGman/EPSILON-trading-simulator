...
export default function ReplicationCheck({ primaryDiagnosis, strategy, stockCodes, initialCash, feeRate, minFee, baselineSlippage, perturbedSlippage, onRun, onComplete }: ReplicationCheckProps) {
  ...
  return (
    <section id="demo-step-5" className={`surface-card rounded-box border px-5 py-7 md:px-8 ${verdict === "not_replicated" ? "border-warning/50 bg-warning/5" : "border-primary/20"}`} aria-label="Pre-specified replication check">
