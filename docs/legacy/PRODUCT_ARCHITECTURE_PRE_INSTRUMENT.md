...
> Historical implementation record, not the current public route map. Use [current architecture](../PRODUCT_ARCHITECTURE.md) for `instrument/`. The Dashboard and account flows below are preserved as development history.
